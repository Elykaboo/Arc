...
export default function CommunityDirectoryClient() {
  ...
  const [searchableProfiles, setSearchableProfiles] = useState<SearchableUserProfile[]>([]);
  const [communityPosts, setCommunityPosts] = useState<CommunityPost[]>([]);
  const [followGraphUsers, setFollowGraphUsers] = useState<FollowGraphUser[]>([]);
  const [searchQuery, setSearchQuery] = useState("");
  const [isLoadingMemberProfiles, setIsLoadingMemberProfiles] = useState(true);
  const [isLoadingPublicProfiles, setIsLoadingPublicProfiles] = useState(true);
  const [isLoadingSearchableProfiles, setIsLoadingSearchableProfiles] = useState(true);
  const [isLoadingCommunityPosts, setIsLoadingCommunityPosts] = useState(true);
  const [isLoadingFollowGraphUsers, setIsLoadingFollowGraphUsers] = useState(true);
